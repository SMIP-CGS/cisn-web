...
// ############################################# Output ################################################################################################ 
  ...
  + '<tr><td>MMI</td>          <td>'+ json.output.ground_motions.MMI.max_grid + json.output.ground_motions.MMI.units +'</td><td style=" padding-right:90px;">'+ json.output.ground_motions.MMI.max+ json.output.ground_motions.MMI.units +'</td><td>'+ json.output.ground_motions.MMI.bias + '</td></tr>'                                                       /*######################### PGA ##################*/
  + '<tr><td>PGA</td>           <td>'+ json.output.ground_motions.PGA.max_grid + json.output.ground_motions.PGA.units +'</td><td style=" padding-right:90px;">'+ json.output.ground_motions.PGA.max+ json.output.ground_motions.PGA.units +'</td><td>'+ json.output.ground_motions.PGA.bias +'</td></tr>'                                                           /*####################### PGV ##################*/
  + '<tr><td>PGV</td>           <td>'+ json.output.ground_motions.PGV.max_grid + json.output.ground_motions.PGV.units +'</td><td style=" padding-right:90px;">'+ json.output.ground_motions.PGV.max+ json.output.ground_motions.PGV.units +'</td><td>'+ json.output.ground_motions.PGV.bias +'</td></tr></table><br/>'                                                              /*######################### SA(0.3) ##################*/
  + '<tr><td>SA(0.3)</td>     <td>'+ json.output.ground_motions["SA(0.3)"].max_grid +json.output.ground_motions["SA(0.3)"].units +'</td><td>'+ json.output.ground_motions["SA(0.3)"].max + json.output.ground_motions["SA(0.3)"].units +'</td><td>'+ json.output.ground_motions["SA(0.3)"].bias +'</td></tr>'                                                              /*######################### SA(1.0) ##################*/
  + '<tr><td>SA(1.0)</td>    <td>'+ json.output.ground_motions["SA(1.0)"].max_grid + json.output.ground_motions["SA(1.0)"].units +'</td><td>'+ json.output.ground_motions["SA(1.0)"].max+ json.output.ground_motions["SA(1.0)"].units +'</td><td>'+ json.output.ground_motions["SA(1.0)"].bias+'</td></tr>'                                                             /*######################### SA(3.0) ##################*/
  + '<tr><td>SA(3.0)</td>    <td>'+ json.output.ground_motions["SA(3.0)"].max_grid + json.output.ground_motions["SA(3.0)"].units +'</td><td>'+ json.output.ground_motions["SA(3.0)"].max+ json.output.ground_motions["SA(3.0)"].units +'</td><td>'+ json.output.ground_motions["SA(3.0)"].bias+'</td></tr>'
